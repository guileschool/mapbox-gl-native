...
/**
 ...
 let source = MGLImageSource(identifier: "radar", coordinateQuad: coordinates, imageURL: URL(string: "https://www.mapbox.com/mapbox-gl-js/assets/radar.gif")!)
...
/**
 ...
 If the receiver was initialized using `-initWithIdentifier:coordinateQuad:imageURL:` or
 if the `URL` property is set, this property is set to `nil`.
 */
